...
`as.matrix(x1)` will then provide allelic dosages, suitable for analysis with several of the `hierfstat` functions, as described in the [hierfstat vignette]("./hierfstat.html"). 
